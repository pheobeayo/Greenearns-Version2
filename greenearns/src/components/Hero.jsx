        ...
        <div className="w-100 md:w-[100%] bg-white">
             <div className='w-100 md:w-[100%] lg:p-16 p-4  grid lg:grid-cols-2 h-[100vh] lg:gap-0 gap-4'>
                                        <div className="flex flex-col gap-4">
                                                <h1 className='text-[40px] md:text-[40px]  font-serif font-bold capitalize  text-[#091913]'>Empower climate change and sustainable carbon reduction through recycling.</h1>
                                                <h3 className='text-[20px] md:text-[20px]  font-serif text-[#091913]'>Trade recyclables on the blockchain, earn rewards, and power  
