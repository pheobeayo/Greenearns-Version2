  ...
  return (
    <main>
      <section className="bg-[#2B452B]/5 relative py-6">
        <div className="lg:w-[70%] md:w-[70%] w-[100%] mx-auto text-center my-12">
        ...
        <div className="flex flex-col lg:flex-row md:flex-row justify-between lg:w-[90%] md:w-[90%] w-[100%] mx-auto mb-10">
          <div className="flex justify-between items-center lg:w-[45%] md:w-[45%] w-[100%]">
            <img src={bgImg} alt="" />
            <img src={image2} alt="" className=" ml-auto" />
          </div>
      ...
      <section className="bg-white py-20">
        <div className="lg:w-[90%] md:w-[90%] w-[100%] mx-auto">
          <h2 className="lg:text-[32px] md:text-[32px] text-[18px] font-[700] text-[#015C28] lg:w-[70%] md:w-[70%] w-[90%] my-12 font-titiliumweb">
            Welcome to GreenEarns, where environmental consciousness meets
            blockchain innovation
          </h2>
          <div className="flex flex-col lg:flex-row md:flex-row justify-between">
            <div className="py-6 border-t-2 border-[#015C28] lg:w-[30%] md:w-[30%] w-[90%] mb-4">
      ...
      <section className="lg:w-[90%] md:w-[90%] w-[100%] mx-auto my-10">
        <h2 className="lg:text-[32px] md:text-[32px] text-[18px] font-[700] my-6 flex justify-between font-titiliumweb items-center">Recyclable materials for sale (Prices are in Unit of Measure) <span className="lg:text-[24px] md:text-[24px] text-[18px] font-[400]">View More</span></h2>
        <MarketplaceHome />
      </section>
