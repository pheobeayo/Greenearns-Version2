    ...
    <main>
       ...
       <section className='flex lg:flex-row md:flex-row flex-col justify-between'>
        <div className='lg:w-[45%] md:w-[45%] w-[100%]'>
            ...
            <p className='font-titiliumweb mb-4 font-bold text-[#015C28] lg:text-[24px] md:text-[24px] text-[20px]'>{convertToWholeNumber(formatUnits(transaction.price))} $tCORE (per unit of measure) </p>
